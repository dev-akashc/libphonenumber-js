...
Regular expressions for all possible phone number [types](..#gettype-string) for this country: `fixed_line`, `mobile`, `toll_free`, `premium_rate`, etc.
